...
public class Boid {
    ...
    public void move_boid_to_new_position(){
        //Calcul de l'accélaration
        Vecteur resultante = rule1();
        resultante.add(rule2());
        resultante.add(rule3());
